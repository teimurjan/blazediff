#!/usr/bin/env node
/**
 * Links the correct platform binary package to @blazediff/interpret-native's node_modules.
...
const BIN_PKG_DIR = path.join(PACKAGES_DIR, "interpret-native");
...
function main() {
	...
	try {
		...
		console.log(
			`Linked: ${platformPkgName} -> packages/interpret-native/node_modules/@blazediff/${platformPkgDir}`,
		);
	} catch (err) {

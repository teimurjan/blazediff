#!/usr/bin/env node
/**
 * Links the correct platform binary package to @blazediff/core-native's node_modules.
...
function main() {
	...
	try {
		...
		console.log(
			`Linked: ${platformPkgName} -> packages/core-native/node_modules/@blazediff/${platformPkgDir}`,
		);
	} catch (err) {

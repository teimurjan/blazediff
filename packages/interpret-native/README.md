...
behind them — colour delta, gradient/edge correlation, chroma-plane movement (`chroma`: hue
rotation, saturation, delta smoothness), fill ratios, and the classifier's signals.

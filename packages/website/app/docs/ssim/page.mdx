...
<Callout type="info">
  **Threshold Guidelines:**
  - Use threshold `>0.99` for strict visual regression testing
  - Use threshold `>0.95` for standard visual regression testing

...
| **Score**     | How different does it look?        | `ssim`, `gmsd`                                  |
| **Interpret** | What changed, where, and how badly?| `interpret()` in `core-native` and `core-wasm`  |
...
| Know what changed and where, not just how much    | `@blazediff/core-native` or `core-wasm`   | Node, browsers                     |

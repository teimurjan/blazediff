...
| **Score**     | How different does it look?        | `ssim`, `gmsd`, `ssim-native`, `milo-native`, `milo-wasm` |
...
| Score what a person would notice, with a learned model | `@blazediff/milo-native`, `@blazediff/milo-wasm` | Node; browsers, Workers, Deno, Bun, edge |

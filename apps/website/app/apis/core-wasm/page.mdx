...
<Callout type="info">
  Region analysis — *what* changed rather than where — is not part of this
  package. It lives in [`@blazediff/interpret-native`](/apis/interpret-native),
  a Node N-API package with no wasm build.
</Callout>
